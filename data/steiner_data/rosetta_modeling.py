...
# ATV
data = pd.read_csv("atv_filtrated.csv")
modeled_sequences = Execute(pdb = "3oxc_edited.pdb", dataframe = data, output_path= 'rosetta_lr/atv')

# DRV
data = pd.read_csv("drv_filtrated.csv")
modeled_sequences = Execute(pdb = "3oxc_edited.pdb", dataframe = data, output_path= 'rosetta_lr/drv')

# FPV
data = pd.read_csv("fpv_filtrated.csv")
modeled_sequences = Execute(pdb = "3oxc_edited.pdb", dataframe = data, output_path= 'rosetta_lr/fpv')

# IDV
data = pd.read_csv("idv_filtrated.csv")
modeled_sequences = Execute(pdb = "3oxc_edited.pdb", dataframe = data, output_path= 'rosetta_lr/idv')

# LPV
data = pd.read_csv("lpv_filtrated.csv")
modeled_sequences = Execute(pdb = "3oxc_edited.pdb", dataframe = data, output_path= 'rosetta_lr/lpv')

# NFV
data = pd.read_csv("nfv_filtrated.csv")
modeled_sequences = Execute(pdb = "3oxc_edited.pdb", dataframe = data, output_path= 'rosetta_lr/nfv')

# SQV
data = pd.read_csv("sqv_filtrated.csv")
modeled_sequences = Execute(pdb = "3oxc_edited.pdb", dataframe = data, output_path= 'rosetta_lr/sqv')

# TPV
data = pd.read_csv("tpv_filtrated.csv")
modeled_sequences = Execute(pdb = "3oxc_edited.pdb", dataframe = data, output_path= 'rosetta_lr/tpv')

...
def train_knn(drug, df):
    ...
    train_df.to_csv(f'{drug}_train.csv')
    test_df.to_csv(f'{drug}_test.csv')

    model = KNeighborsClassifier(n_neighbors=6)

    results_list = []  # List to store results of each fold
...
# FPV
os.chdir('/home/rocio.maidana/proj.rocio.maidana/benchmakrs/dados_proprios/knn/fpv')
cv_r, test_r = train_knn('FPV', data)

# NFV
os.chdir('/home/rocio.maidana/proj.rocio.maidana/benchmakrs/dados_proprios/knn/nfv')
cv_r, test_r = train_knn('NFV', data)

# IDV
os.chdir('/home/rocio.maidana/proj.rocio.maidana/benchmakrs/dados_proprios/knn/idv')
cv_r, test_r = train_knn('IDV', data)

# ATV
os.chdir('/home/rocio.maidana/proj.rocio.maidana/benchmakrs/dados_proprios/knn/atv')
cv_r, test_r = train_knn('ATV', data)

# LPV
os.chdir('/home/rocio.maidana/proj.rocio.maidana/benchmakrs/dados_proprios/knn/lpv')
cv_r, test_r = train_knn('LPV', data)

# SQV
os.chdir('/home/rocio.maidana/proj.rocio.maidana/benchmakrs/dados_proprios/knn/sqv')
cv_r, test_r = train_knn('SQV', data)

# TPV
os.chdir('/home/rocio.maidana/proj.rocio.maidana/benchmakrs/dados_proprios/knn/tpv')
cv_r, test_r = train_knn('TPV', data)

# DRV
os.chdir('/home/rocio.maidana/proj.rocio.maidana/benchmakrs/dados_proprios/knn/drv')

...
# ATV
df = pd.read_csv('atv_steiner_triang.csv')
cv_r, test_r = train_knn('ATV', df)

# NFV
df = pd.read_csv('nfv_steiner_triang.csv')
cv_r, test_r = train_knn('NFV', df)

# IDV
df = pd.read_csv('idv_steiner_triang.csv')
cv_r, test_r = train_knn('IDV', df)

# FPV
df = pd.read_csv('fpv_steiner_triang.csv')
cv_r, test_r = train_knn('FPV', df)

# LPV
df = pd.read_csv('lpv_steiner_triang.csv')
cv_r, test_r = train_knn('LPV', df)

# SQV
df = pd.read_csv('sqv_steiner_triang.csv')
cv_r, test_r = train_knn('SQV', df)

# TPV
df = pd.read_csv('tpv_steiner_triang.csv')
cv_r, test_r = train_knn('TPV', df)

# DRV
df = pd.read_csv('drv_steiner_triang.csv')
cv_r, test_r = train_knn('DRV', df)

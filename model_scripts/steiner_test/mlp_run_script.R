### MLP Run Script ###
# setwd('/hiv_pr_benchmarks/data/steiner_data/nn_models') # train data
...
#iterate through 5 folds & save output
  ...
  for(i in 1:k){
    ...
    save_model_tf(model, paste(infile,i,"mlp_model",sep="")) 
...
# Save results from rocout_list to csv files
  write.csv(rocout_list[[1]],file=paste(infile,"mlp_roc.1.csv",sep=""))
  write.csv(rocout_list[[2]],file=paste(infile,"mlp_roc.2.csv",sep=""))
  write.csv(rocout_list[[3]],file=paste(infile,"mlp_roc.3.csv",sep=""))
  write.csv(rocout_list[[4]],file=paste(infile,"mlp_roc.4.csv",sep=""))
  write.csv(rocout_list[[5]],file=paste(infile,"mlp_roc.5.csv",sep=""))
}

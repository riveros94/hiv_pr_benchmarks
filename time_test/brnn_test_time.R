...
#In-house test
model_path <- "nfv.fasta2brnn_model"
fasta_path <- "seq_test.fasta"
output_prefix <- "inhouse_brnn"
result <- load_and_predict(model_path, fasta_path, output_prefix)

#Steiner test
model_path <- "nfv_train.fasta2brnn_model"
fasta_path <- "seq_test.fasta"
output_prefix <- "steiner_brnn"
result <- load_and_predict(model_path, fasta_path, output_prefix)

#Shen test
model_path <- "nfv.fasta3brnn_model"
fasta_path <- "seq_test.fasta"
output_prefix <- "shen_brnn"
result <- load_and_predict(model_path, fasta_path, output_prefix)

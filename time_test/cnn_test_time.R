...
#In-house test
model_path <- "nfv.fasta3cnn_model"
fasta_path <- "seq_test.fasta"
output_prefix <- "inhouse_cnn"
result <- load_and_predict(model_path, fasta_path, output_prefix)

#Shen test
model_path <- "nfv.fasta1cnn_model"
fasta_path <- "seq_test.fasta"
output_prefix <- "shen_cnn"
result <- load_and_predict(model_path, fasta_path, output_prefix)

#Steiner test
model_path <- "nfv_train.fasta1cnn_model"
fasta_path <- "seq_test.fasta"
output_prefix <- "steiner_cnn"
result <- load_and_predict(model_path, fasta_path, output_prefix)
